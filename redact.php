...
<body>
		...
		<div class="col-8 mx-auto" >
			<div class="row">
				...
				<div class="col-9 pt-4" >
					...
					<a href="" class="text-light ms-4 text-uppercase">Сообществ</a>
	...
	<div class="col-12" style="background-color: #212429; height: 100%;">
		<div class="col-8 mx-auto pt-5">
				<h1 class="text-uppercase text-light mt-5 fw-light">ОСНОВНОЕ</h1>
				<form action="profile.php" method="GET"> 		
					<p class="text-white m-0">Имя аккаунта Steam</p>
					<input type="text" name="profilename"  class="w-25 form-control bg-dark text-white">

					<p class="text-white m-0 mt-3">Электронная почта</p>
					<input type="text" name="mail" class="w-25 form-control bg-dark text-white">

					<p class="text-white m-0  mt-3">Возраст</p>
					<input type="number" name="age" class="w-25 form-control bg-dark text-white">

					<p class="text-white m-0  mt-3">Пароль</p>
					<input type="number" name="pass" class="w-25 form-control bg-dark text-white">
